                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">
                                @if (Route::is('company_policy.edit'))
                                    Edit Company Policy Record
                                @else
                                    Add Company Policy Record
                                @endif
                                ...
                                <div class="card-body p-0">
                                    ...
                                    @if(Route::is('company_policy.add'))
                                        <form action="{{route('company_policy.store')}}" method="POST">         
                                            @csrf  
                                            @include('policy.companies_policyadd_form')
                                        </form>
                                    @elseif(Route::is('company_policy.edit'))
                                        <form action="{{route('company_policy.editpost', ['id' => $id])}}" method="POST">         
                                            @csrf                                          
                                            @include('policy.companies_policyadd_form')
                                        </form>
                                    @endif
