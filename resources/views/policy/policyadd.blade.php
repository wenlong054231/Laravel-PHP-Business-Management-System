        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Customer Policy</h1>
                        ...
                        <div class="card-header py-3">
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">
                                @if (Route::is('policy.edit'))
                                    Edit Customer Policy Record
                                @else
                                    Add Customer Policy Record
                                @endif
                                ...
                                <div class="card-body p-0">
                                    ...
                                    @if(Route::is('policy.add'))
                                        <form action="{{route('policy.store',['id'=> $id])}}" method="POST">         
                                            @csrf  
                                            @include('policy.policyadd_form')
                                        </form>
                                    @elseif(Route::is('policy.edit'))
                                        <form action="{{route('policy.editpost', ['id' => $id])}}" method="POST">         
                                            @csrf                                          
                                            @include('policy.policyadd_form')
                                        </form>
                                    @endif
