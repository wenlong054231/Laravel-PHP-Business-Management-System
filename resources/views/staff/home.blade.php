...
<body id="page-top">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="import/img/undraw_profile.svg">
                            </a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-lg-7">
                                <div class="card shadow mb-4">
                                    ...
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <div class="chart-area" id="chart-container" data-sales='{{ json_encode($salesData) }}'>
                            ...
                            <div class="col-xl-4 col-lg-5">
                                <div class="card shadow mb-4">
                                    ...
                                    <div
                                        class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">Sales From (%)</h6>
                                        <div class="dropdown no-arrow">
                                            <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                    ...
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <div class="chart-pie pt-4 pb-2" id="pie-container" data-percentage='{{ json_encode($salesPercentage)}}'>
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                                            ...
                                            <h6 class="m-0 font-weight-bold text-primary">Expired Policies</h6>
                                        </a>
                                    ...
                                    <div class="collapse show" id="collapseCardExample">
                                        @if ($expiredPolicies->isEmpty())
                                            ...
                                            <div class="card-body mb-4 ">None</div>
                                       
                                        @else
                                            @foreach ($expiredPolicies as $policy)
                                                <div class="card mb-4 border-left-warning">
                                                    <div class="card-body">
                                                        Name: {{ $policy->first_name }} {{ $policy->last_name }}<br>
                                                        {{ $policy->expired_date }} {{$policy->customer->phone}}

                                                        <form action="{{ route('customer.notify',['id' => $policy->customer->id]) }}" method="post">
                                                            @csrf                                                                                              
                                                            <button type="submit" class="btn btn-primary">Send Message</button>
                                                        </form>
                                                        @if (session('message') && session('user_id') == $policy->customer->id)
                                                            <div class="alert alert-success">
                                                                {{ session('message') }}
                                                            </div>
                                                        @endif

                                                        @if (session('error') && session('user_id') == $policy->customer->id)
    ...
    <script src="import/js/demo/chart-area-demo.js"></script>
    <script src="import/js/demo/chart-pie-demo.js"></script>
